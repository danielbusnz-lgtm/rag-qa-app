...
\node[step=teal, below=3.2cm of client, xshift=-1.5cm]
...
\node[step=orange, below=2.2cm of url]
...
\node[service=primary, below=2.2cm of chunker, xshift=-1.5cm]
...
\node[service=purple, below=3cm of rag]
